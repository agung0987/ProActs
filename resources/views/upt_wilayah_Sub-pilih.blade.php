...
@php
    ...
    $next = "lap_sub_upt_wilayah?_token=$_token&caritahun=$_tahun&caribulan=$_bulan&cariupt=$_upt&cariwilayah=$_wilayah&limit=".($halskrng+1);
    $prev = "lap_sub_upt_wilayah?_token=$_token&caritahun=$_tahun&caribulan=$_bulan&cariupt=$_upt&cariwilayah=$_wilayah&limit=".($halskrng-1);
@endphp
  ...
  <div class="container-sm ">
    <div class="table-responsive">
      ...
      <div class="container d-flex h-100 col justify-content-center align-self-center">
                    <div class="col-11">
                    <table>
                            <div class="judul" style="float:left; width: 100%; height:80px; ">
                            <h2><b> Laporan Sub Per-UPT</b></h2>
                            </div>
                            <form action="/lap_sub_upt_wilayah" >
                            <div style="float:left; width: 100%; height:40px;">
                            <label for="cars1"><b>Tahun &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b></label>
                                <select id="cars1" style="width: 200px" name="caritahun">
                            ...
                            <div style="float:left; width: 100%; height:40px;">
                                <label for="cars3"><b>Upt &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; :</b></label>
                                <select id= "cars3" name="cariupt" >
        ...
        <table class="table table-striped table-hover rounded">
          ...
          <tbody>
            @foreach($dataSupUptwil as $data_get)
            ...
            <tr>
              ...
              <!-- <td style="width: 0rem;">
                <div>
              <form action="{{url('sub_upt_wilayah')}}">
