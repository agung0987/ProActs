            ...
            <nav class="sb-sidenav accordion sb-sidenav" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav ">
                        ...
                        <br>
                        <div class="p-1 pl-3 sb-sidenav-menu-heading"><h5>Master Data</h5> </div>
                        ...
                        <a class="p-1 pl-3 nav-link {{ Request::is('tb-jabatan') ? 'active' : ''}}" style="color:#fff" href="{{ url('/tb-jabatan') }}">
                            <div class="sb-nav-link-icon"><i class="bi bi-bar-chart-line"></i></div>
                            Data Jabatan
                        </a>
                        <a class="p-1 pl-3 nav-link {{ Request::is('tb-wilayah') ? 'active' : ''}}" style="color:#fff" href="{{url('/tb-wilayah')}}">
                            <div class="sb-nav-link-icon"><i class="bi bi-pin-map"></i></div>
                            Data Wilayah
                        </a>
                        <a class="p-1 pl-3 nav-link {{ Request::is('tb-upt') ? 'active' : ''}}" style="color:#fff" href="{{ url('/tb-upt') }}">
                        ...
                        <a class="p-1 pl-3 nav-link {{ Request::is('kuesioner') ? 'active' : ''}}" style="color:#fff" href="{{ url('/kuesioner') }}">
                        ...
                        <div class="sb-sidenav-menu-heading"><h5>Penilaian</h5></div>
                        ...
                        <!-- Laporan -->
                        <div class="sb-sidenav-menu-heading"><h5>Laporan</h5></div>
                        ...
                        <div class="p-1 pl-3 sb-sidenav-menu-heading"><h5> Pengaturan</h5></div>
