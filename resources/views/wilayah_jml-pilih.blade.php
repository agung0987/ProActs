...
$next = "lap_jml_wilayah?_token=$_token&caritahun=$_tahun&caribulan=$_bulan&cariwilayah=$_wilayah&limit=".($halskrng+1);
$prev = "lap_jml_wilayah?_token=$_token&caritahun=$_tahun&caribulan=$_bulan&cariwilayah=$_wilayah&limit=".($halskrng-1);
@endphp
                    ...
                    <div class="table-wrapper">
                        <div class="container d-flex h-100 col justify-content-center align-self-center">
                            <div class="col-11">
                                ...
                                <table>
                                    <h2 class="judul"> <b>Laporan per Wilayah</b></h2>
